...
| --- | --- | --- | --- | --- | --- | --- |
| CtrlRetSTR | rank_mean_across_horizons_1m_3m_6m_12m__dmcs | 0.677 | 0.677 | *** | 121 | 重点关注相关性风险 |
| CtrlRetLTM | rank_mean_across_horizons_1m_3m_6m_12m__dmcs | 0.594 | 0.594 | *** | 121 | 重点关注相关性风险 |
| FAC__x__rank_mean_across_horizons_1m_3m_6m_12m__dmcs | rank_mean_across_horizons_1m_3m_6m_12m__dmcs | -0.513 | 0.513 | *** | 121 | 重点关注相关性风险 |

## 三、VIF 风险变量

按 `p90_vif > 5.0` 口径，本次发现 3 个 VIF 风险变量：

| variable | mean_vif | median_vif | p90_vif | max_vif | ok_months | failed_or_skipped_months | risk_level |
| --- | --- | --- | --- | --- | --- | --- | --- |
| rank_mean_across_horizons_1m_3m_6m_12m__dmcs | 8.383 | 7.798 | 11.866 | 29.431 | 114 | 101 | VIF 风险 |
| CtrlRetSTR | 6.248 | 5.346 | 8.901 | 34.286 | 114 | 101 | VIF 风险 |
| CtrlRetLTM | 4.467 | 4.232 | 6.423 | 10.068 | 114 | 101 | VIF 风险 |
